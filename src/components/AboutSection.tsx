...
const ABOUT_TEXT =
  'With more than six years of experience building software, i focus on backend systems, APIs, and cloud infrastructure. I care about clean, modular code that is built to last, and i enjoy working with teams shipping things that actually scale. Let’s build something solid together!'
